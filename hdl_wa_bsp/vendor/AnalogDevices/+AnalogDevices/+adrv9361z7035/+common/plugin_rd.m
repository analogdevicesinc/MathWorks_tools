...
switch(upper(design))
	...
	case 'AGC'
		hRD.addCustomVivadoDesign( ...
			'CustomBlockDesignTcl', fullfile('projects', 'adrv9361z7035', [lower(board),'_agc'], 'system_project_tx.tcl'), ...
			'CustomTopLevelHDL',    fullfile('projects', 'adrv9361z7035', [lower(board),'_agc'], 'system_top.v'));
	case 'TX'
		hRD.addCustomVivadoDesign( ...
