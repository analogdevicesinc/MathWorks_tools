...
hRD.ReferenceDesignName = sprintf('FMCOMMS5 %s Base System (Vivado 2015.2)', upper(board));
...
switch(upper(design))
	...
	case 'RX & TX'
		hRD.addCustomVivadoDesign( ...
			'CustomBlockDesignTcl', fullfile('projects', 'fmcomms5', lower(board), 'system_project_rx_tx.tcl'), ...
			'CustomTopLevelHDL',    fullfile('projects', 'fmcomms5', lower(board), 'system_top.v'));
	otherwise
		hRD.addCustomVivadoDesign( ...
