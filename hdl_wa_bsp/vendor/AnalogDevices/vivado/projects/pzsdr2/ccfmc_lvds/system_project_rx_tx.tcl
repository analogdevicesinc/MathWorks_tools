set ad_hdl_dir    	[pwd]
set ad_phdl_dir   	[pwd]
set proj_dir		$ad_hdl_dir/projects/pzsdr2/ccfmc_lvds

source $ad_hdl_dir/projects/scripts/adi_project.tcl
source $ad_hdl_dir/projects/scripts/adi_board.tcl

set p_device "xc7z035ifbg676-2L"
adi_project_create pzsdr2_ccfmc_lvds $proj_dir config_rx_tx.tcl
adi_project_files pzsdr2_ccfmc_lvds [list \
  ...
  "$ad_hdl_dir/projects/pzsdr2/common/ccfmc_constr.xdc" \
  "system_top.v" ]
