...
#connect_bd_net [get_bd_pins axi_ad9361_adc_dma/s_axis_aclk] [get_bd_pins sys_ps7/FCLK_CLK0]
...
#connect_bd_net [get_bd_pins axi_ad9361_adc_dma/s_axis_ready] [get_bd_pins HDL_DUT_ip_0/AXI4_Lite_ACLK]
