classdef Rx < adi.ADRV9009ZU11EG.Base & adi.common.Rx & matlab.system.mixin.SampleTime
    ...
    methods
        ...
        function set.GainControlModeChipB(obj, value)
            ...
            if obj.ConnectedToDevice
                id = 'voltage0';
                obj.ADRV9009_B_Rx.setAttributeRAW(id,'gain_control_mode',value,false);
            end
        end
        % Check GainChannel0
        function set.GainChannel0(obj, value)
            ...
            if obj.ConnectedToDevice && strcmp(obj.GainControlModeChipA,'manual')
                id = 'voltage0';
        ...
        function set.GainChannel2(obj, value)
            ...
            if obj.ConnectedToDevice && strcmp(obj.GainControlModeChipB,'manual')
                id = 'voltage0';
                obj.ADRV9009_B_Rx.setAttributeLongLong(id,'hardwaregain',value,false);
            end
        end
