function wlan80211BeaconRxModelParams(mode)
% wlan80211BeaconRxModelParams Manage 802.11 Beacon Frame receiver model
    ...
    case 'init'
        ...
        try
            validateattributes(agcStepSize, {'numeric'}, ...
                ...
                'wlan80211BeaconRxModelParams', '''AGC step size''');
        catch e
            if strcmp(e.identifier, ...
                    'MATLAB:wlan80211BeaconRxModelParams:notLess')
        ...
        validateattributes(agcMaxGain, {'numeric'}, ...
            ...
            'wlan80211BeaconRxModelParams', '''Maximum AGC gain''');
        
        validateattributes(corrThreshold, {'numeric'}, ...
            {'real','positive','scalar', 'nonnan', 'finite'}, ...
            'wlan80211BeaconRxModelParams', '''Synchronization threshold''');
        
        sampsPerChip = 2;
        p80211 = wlan80211BeaconRxInit(agcStepSize, agcMaxGain, ...
