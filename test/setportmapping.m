function setportmapping(mdl,mode,numChannels,ReferenceDesignName)
...
switch mode
    case 'tx'
        ...
        hdlset_param([mdl,'/HDL_DUT/out1'], 'IOInterface', [dev,' DAC Data I0 [0:15]']);
        hdlset_param([mdl,'/HDL_DUT/out1'], 'IOInterfaceMapping', '[0:15]');
        hdlset_param([mdl,'/HDL_DUT/out2'], 'IOInterface', [dev,' DAC Data Q0 [0:15]']);
        ...
        if numChannels==4
            ...
            hdlset_param([mdl,'/HDL_DUT/out3'], 'IOInterface', [dev,' DAC Data I1 [0:15]']);
            hdlset_param([mdl,'/HDL_DUT/out3'], 'IOInterfaceMapping', '[0:15]');
            hdlset_param([mdl,'/HDL_DUT/out4'], 'IOInterface', [dev,' DAC Data Q1 [0:15]']);
            hdlset_param([mdl,'/HDL_DUT/out4'], 'IOInterfaceMapping', '[0:15]');
        end
    case 'rx'
        hdlset_param([mdl,'/HDL_DUT/in1'], 'IOInterface', [dev,' ADC Data I0 [0:15]']);
        hdlset_param([mdl,'/HDL_DUT/in1'], 'IOInterfaceMapping', '[0:15]');
        hdlset_param([mdl,'/HDL_DUT/in2'], 'IOInterface', [dev,' ADC Data Q0 [0:15]']);
        hdlset_param([mdl,'/HDL_DUT/in2'], 'IOInterfaceMapping', '[0:15]');
        ...
        hdlset_param([mdl,'/HDL_DUT/out2'], 'IOInterfaceMapping', '[0:15]');
        if numChannels==4
            hdlset_param([mdl,'/HDL_DUT/in3'], 'IOInterface', [dev,' ADC Data I1 [0:15]']);
            hdlset_param([mdl,'/HDL_DUT/in3'], 'IOInterfaceMapping', '[0:15]');
            hdlset_param([mdl,'/HDL_DUT/in4'], 'IOInterface', [dev,' ADC Data Q1 [0:15]']);
            hdlset_param([mdl,'/HDL_DUT/in4'], 'IOInterfaceMapping', '[0:15]');
    ...
    case 'rx_tx'
        ...
        hdlset_param([mdl,'/HDL_DUT/in4'], 'IOInterfaceMapping', '[0:15]');
        hdlset_param([mdl,'/HDL_DUT/out3'], 'IOInterface', [dev,' DAC Data I0 [0:15]']);
        hdlset_param([mdl,'/HDL_DUT/out3'], 'IOInterfaceMapping', '[0:15]');
        hdlset_param([mdl,'/HDL_DUT/out4'], 'IOInterface', [dev,' DAC Data Q0 [0:15]']);
        hdlset_param([mdl,'/HDL_DUT/out4'], 'IOInterfaceMapping', '[0:15]');
        ...
        if numChannels==4
            ...
            hdlset_param([mdl,'/HDL_DUT/out5'], 'IOInterface', [dev,' DAC Data I1 [0:15]']);
            hdlset_param([mdl,'/HDL_DUT/out5'], 'IOInterfaceMapping', '[0:15]');
            hdlset_param([mdl,'/HDL_DUT/out6'], 'IOInterface', [dev,' DAC Data Q1 [0:15]']);
            hdlset_param([mdl,'/HDL_DUT/out6'], 'IOInterfaceMapping', '[0:15]');
            
            hdlset_param([mdl,'/HDL_DUT/in7'], 'IOInterface', [dev,' ADC Data I1 [0:15]']);
            hdlset_param([mdl,'/HDL_DUT/in7'], 'IOInterfaceMapping', '[0:15]');
            hdlset_param([mdl,'/HDL_DUT/in8'], 'IOInterface', [dev,' ADC Data Q1 [0:15]']);
